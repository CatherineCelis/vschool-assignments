...
function printVoterTurnout (voterList){  
    // Let's sort the voters into their respective age groups
    // Now that we have the voters sorted let's determine the turnout percentage. As an intermediate step let's write a function that calculates percentages.
    // Let's string format and print each result to the console and specified
}
...
function printVoterTurnout (voters) {  
    ...
    // first start by creating a few arrays where our sorted voters will live
    var ageGroup1 = [];
    var ageGroup2 = [];
    var ageGroup3 = [];
