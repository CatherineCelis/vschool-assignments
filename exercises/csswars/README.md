...
This project felt like a brief introduction to using css first hand for me. I learned how to find and skim css libraries on the web to find out which attributes I needed to use and which attributes would work best.3/5/18 11:51 pm.